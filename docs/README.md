...
These documents are the canonical project documentation for assessors, developers, and future agents. They replace `docs/init.md`, which was bootstrap planning material.
...
- [NLP Pipeline](nlp-pipeline.md): sentiment, issue classification, Reputation Risk, semantic similarity, and model tracking.
