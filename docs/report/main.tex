...
\IfFileExists{figures/UoM Logo.png}{%
  \includegraphics[width=3.0cm]{"figures/UoM Logo.png"}\\[0.35cm]
}{%
  {\Large\bfseries University of Moratuwa}\\[0.35cm]
}
{\Large\bfseries University of Moratuwa}\\[0.15cm]
{\large Faculty of Computer Science and Engineering}\\[0.75cm]

{\color{navy}\rule{\linewidth}{1.4pt}}\\[0.45cm]
{\Huge\bfseries Guest Review Intelligence\\[4pt] \& Action Management System}\\[0.35cm]
{\Large A Reputation-Protection Platform for The Kingsbury, Colombo}\\[0.3cm]
{\color{navy}\rule{\linewidth}{1.4pt}}\\[0.8cm]

{\large\bfseries Final Module Report}\\[0.15cm]
{\itshape Turning thousands of scattered guest reviews into a prioritised,\\ department-owned action list, before problems define the brand.}\\[0.9cm]
